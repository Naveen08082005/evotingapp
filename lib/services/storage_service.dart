...
class StorageService {
  ...
  Future<String> uploadCandidatePhoto({
    ...
    try {
      ...
      throw const AppStorageException('Failed to upload candidate photo. Please try again.');
    }
  }
  ...
  Future<String> uploadUserPhoto({
    ...
    try {
      ...
      throw const AppStorageException('Failed to upload user photo. Please try again.');
    }
  }
  ...
  Future<void> deleteFile({
    ...
    try {
      ...
      throw const AppStorageException('Failed to delete file. Please try again.');
    }
  }
